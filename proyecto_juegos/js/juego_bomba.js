class BombGame {
  constructor(canvasId){
    ...
    this.attempt = [];
    this.wirePositions = []; // contendrá las posiciones clicables
    this.init();
  }
